...
python -m unittest discover -s omega/tests  # run the test suite (92 tests)
```
...
history in [`omega/docs/RESEARCH_LOG.md`](omega/docs/RESEARCH_LOG.md) (milestones Ω-0.1 → Ω-0.53).
