...
| **exp034** sustained novelty | Can the 120k novelty-rate decay (exp032's open edge) be arrested? | **Yes — the founding thesis, confirmed.** Turning the *reification* lever on within a level (persistent motifs → new atoms, alphabet 32→91) turns a baseline rate that halves (0.52→0.27 over 30k) into one that holds (0.53→0.67, **2.38× baseline** late) while heredity stays alive. Growing **constructibility, not space**, sustains novelty. |
